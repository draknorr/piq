...
| Evidence/gaps                          | Iteration 1-4 ledgers, with measured performance, browser evidence, human labels/calibrated traction, and the unapproved readiness-function write explicitly gated             |
