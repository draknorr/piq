...
| Evidence/gaps                          | Iteration 1-8 ledgers, with measured performance, scoped-presentation control, browser evidence, natural-run status, human labels/calibrated traction, and readiness-function evidence explicitly separated |
