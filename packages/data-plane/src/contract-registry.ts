...
export const CONTRACT_REGISTRY: QueryContractDescriptor[] = [
  ...
  {
    name: "getInsightsDashboard",
    endpoint: "/v1/contracts/get-insights-dashboard",
    status: "ready",
    requiredRelations: [
      "apps",
      "latest_daily_metrics",
    ...
    description:
      "Return the existing top, newest, and trending Insights shapes from current Tiger CCU and product data.",
    naturalLanguageStrength: [
      "Insights product surface",
      "top current Steam games",
      "new releases and CCU growth",
    ],
  },
  {
    name: "getProductHealth",
    endpoint: "/v1/contracts/get-product-health",
    status: "ready",
    requiredRelations: [
      "apps",
      "publishers",
    ...
    description:
      "Return Tiger-backed catalog counts, ingestion health, queue state, PICS progress, readiness, and admin diagnostics.",
    naturalLanguageStrength: [
      "dashboard catalog counts",
      "admin ingestion health",
      "PICS cursor and queue freshness",
    ],
  },
];
