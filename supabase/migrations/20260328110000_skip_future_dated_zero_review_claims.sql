-- Exclude future-dated zero-review titles from routine review claims.
-- Keep explicit override promotions eligible so manual priority signals still work.
...
COMMENT ON FUNCTION claim_apps_for_reviews_sync IS
    'Claim due apps for reviews sync from a bounded sync_status seed with future-dated zero-review titles suppressed outside override paths.';
